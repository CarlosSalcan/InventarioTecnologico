...
const inventoryController = {
    ...
    getImpresoraInventory: (req, res) => {
        const { id } = req.params; // ID del registro de la impresora
        const query = 'SELECT * FROM impresora WHERE cod_equipo = ?';
    ...
    getLaptopInventory: (req, res) => {
        const { id } = req.params; // ID del registro de la impresora
        const query = 'SELECT * FROM laptop WHERE cod_equipo = ?';
