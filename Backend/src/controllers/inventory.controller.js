...
const inventoryController = {
    ...
    getEscritorioInventory: (req, res) => {
        const query = `
            SELECT 
                c.cod_cpu, c.cod_equipo AS cod_cpu_equipo, c.cod_tics_cpu, c.mar_cpu, c.ser_cpu, c.tar_madre, c.procesador, c.velocidad, c.memoria, c.tam_hdd, c.disp_optico, c.red_fija, 
                c.red_inalam, c.bluetooth, c.lec_tarjeta, c.sis_ope, c.office, c.antivirus, c.nom_antivirus, c.ver_antivirus, c.nom_hots, c.nom_usuario AS nom_usuario_cpu, c.ip_equipo, 
                c.con_cpu, c.est_cpu, c.observacion, c.nom_usua AS nom_usua_cpu,
