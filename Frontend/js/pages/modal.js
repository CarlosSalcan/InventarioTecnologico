        ...
        .then(data => {
            if (data.success) {
                ...
                data.data.forEach(item => {
                    ...
                    option.value = item.cod_piso || item.cod_servicio || item.nom_memoria || item.nom_proce || item.nom_tam_hdd || item.nom_dis_opt || item.nom_sis_ope || item.nom_office || item.nom_antivirus || item.nom_condicion || item.nom_estado;
                    option.textContent = item.nom_piso || item.nom_servicio || item.nom_memoria || item.nom_proce || item.nom_tam_hdd || item.nom_dis_opt || item.nom_sis_ope || item.nom_office || item.nom_antivirus || item.nom_condicion || item.nom_estado;
